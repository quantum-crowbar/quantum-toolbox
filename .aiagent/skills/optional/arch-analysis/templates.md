...
## Architecture Documentation Index Template

This is the main entry point created in `{docs-directory}/architecture-docs/index.md`.
...
**Codebase Version**: {commit hash or tag}

---

## Executive Summary

{2-3 paragraphs summarizing the system:}
- What is this system?
...
|---|----------|--------|-------------|
| 1 | [Technology Manifest](analysis/01-technology-manifest.md) | ⏳/✅ | Languages, frameworks, dependencies |
| 2 | [Interface Specification](analysis/02-interface-specification.md) | ⏳/✅ | APIs, contracts, boundaries |
| 3 | [Architecture Diagrams](analysis/03-architecture-diagrams.md) | ⏳/✅ | Visual system overview |
| 4 | [Documentation Audit](analysis/04-documentation-audit.md) | ⏳/✅ | Existing docs assessment |
| 5 | [Dependency Health](analysis/05-dependency-health.md) | ⏳/✅ | Security and maintenance status |
| 6 | [Data Flow Map](analysis/06-data-flow-map.md) | ⏳/✅ | Data lifecycle and movement |
| 7 | [Error Handling](analysis/07-error-handling.md) | ⏳/✅ | Error patterns and recovery |

**Status Legend**: ⏳ Pending | ✅ Complete | ⚠️ Issues Found
...
1. **{Issue Title}**: {Brief description} → See [relevant doc](analysis/XX-file.md#section)

### Recommendations

| Priority | Recommendation | Effort | Impact |
|----------|----------------|--------|--------|
| High | {recommendation} | {S/M/L} | {description} |
| Medium | {recommendation} | {S/M/L} | {description} |
| Low | {recommendation} | {S/M/L} | {description} |

---

## Architecture Overview

{Include high-level architecture diagram here - copy from 03-architecture-diagrams.md}
...
- **Want to understand the tech stack?** → [Technology Manifest](analysis/01-technology-manifest.md)
- **Looking for API documentation?** → [Interface Specification](analysis/02-interface-specification.md)
- **Need visual overview?** → [Architecture Diagrams](analysis/03-architecture-diagrams.md)
- **Checking documentation quality?** → [Documentation Audit](analysis/04-documentation-audit.md)
- **Assessing dependency risks?** → [Dependency Health](analysis/05-dependency-health.md)
- **Understanding data flow?** → [Data Flow Map](analysis/06-data-flow-map.md)
- **Reviewing error handling?** → [Error Handling](analysis/07-error-handling.md)

### Related Documentation

- [Original README](../README.md) - Project's own documentation
- {Other relevant docs}
...
| Field | Value |
|-------|-------|
| Analysis Tool | AI Agent - arch-analysis skill |
...
*Generated by [arch-analysis skill](.aiagent/skills/optional/arch-analysis/)*
```
