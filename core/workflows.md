...
> **Commands** (`/help`, `/skills`, `/start`, `/update`) and the **Bootstrap workflow** are defined in [skills/core/bootstrap/](../skills/core/bootstrap/). Read that skill when any of those commands are triggered.
